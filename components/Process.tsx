...
const steps = [
  {
    ...
    title: "Discovery",
    description:
      "Deep-dive into your goals, constraints, and technical landscape to define the right problem.",
    color: "#00D4FF",
  },
  {
    number: "02",
    title: "Architecture",
    description:
      "Design scalable, secure system blueprints with clear trade-off analysis and tech selection.",
    color: "#3BBFFF",
  },
  {
    number: "03",
    title: "Build",
    description:
      "Iterative development with weekly demos, automated testing, and continuous integration.",
    color: "#5D8EFF",
  },
  {
    number: "04",
    title: "Deploy",
    description:
      "Zero-downtime production releases with full observability, alerting, and rollback capability.",
    color: "#6E7AFF",
  },
  {
    number: "05",
    title: "Scale",
    description:
      "Performance optimization, capacity planning, and ongoing engineering support as you grow.",
    color: "#7B61FF",
  },
];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile: vertical steps — each watches itself */}
