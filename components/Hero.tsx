...
function AnimatedWord() {
  ...
  return (
    <span className="gradient-text">{words[index]}</span>
  );
}
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-5 sm:px-8 pt-28 pb-20 flex flex-col items-center text-center gap-5 sm:gap-6">
        ...
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: dur, delay: prefersReduced ? 0 : 0.1, ease }}
        ...
        <motion.p
          initial={{ opacity: 0, y: prefersReduced ? 0 : 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: dur, delay: prefersReduced ? 0 : 0.2, ease }}
        ...
        <motion.p
          initial={{ opacity: 0, y: prefersReduced ? 0 : 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: dur, delay: prefersReduced ? 0 : 0.3, ease }}
        ...
        <motion.div
          initial={{ opacity: 0, y: prefersReduced ? 0 : 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: dur, delay: prefersReduced ? 0 : 0.4, ease }}
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: dur, delay: prefersReduced ? 0 : 0.5, ease }}
