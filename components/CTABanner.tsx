        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(0,212,255,0.07) 0%, rgba(123,97,255,0.05) 40%, transparent 70%)",
              }}
              aria-hidden="true"
            />
            <div
            ...
            <div className="relative z-10">
              ...
              >
                ...
                with a clear path forward — no sales pitch, just honest
                engineering advice.
              </motion.p>
